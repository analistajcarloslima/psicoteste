 ...
 * @author fatima
 */
public class TelaRelatorioTanques extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_de_Funcionário
     */
    public TelaRelatorioTanques() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório de Tanques");

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Selecione a Situação do Tanque");

        jcTutorial.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "------", "Disponíveis", "Indisponíveis" }));
  ...
  //          sql += " and lote.idLote=" + l.getIdLote();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioTanques.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author fatima
 */
public class TelaRelatorioTanquesEmLotes extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_de_Funcionário
     */
    public TelaRelatorioTanquesEmLotes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório de Lotes");
  ...
  //          sql += " and lote.idLote=" + l.getIdLote();
    ...
    //        parametros.put("texto", sql);
        ...
        try {
                ...
                pathjrxml = JasperCompileManager.compileReport("C:\\Documents and Settings\\Usuario\\Meus documentos\\NetBeansProjects\\psicoteste\\src\\techpesc\\relatorio\\ListTanques.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioTanquesEmLotes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

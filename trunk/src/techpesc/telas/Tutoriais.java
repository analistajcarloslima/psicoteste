 ...
 * @author fatima
 */
public class Tutoriais extends javax.swing.JDialog {
    ...
    private void btIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btIniciarActionPerformed
        if (jcTutorial.getSelectedItem().toString() != "------") {
            ...
            if (jcTutorial.getSelectedItem().toString() == "Entrada Alevino") {
                try {
                    java.awt.Desktop.getDesktop().open(new File("src\\techpesc\\tutoriais\\EntradaAlevino.mp4"));
                } catch (IOException ex) {
                    Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if (jcTutorial.getSelectedItem().toString() == "Fornecedor") {
                try {
                    java.awt.Desktop.getDesktop().open(new File("src\\techpesc\\tutoriais\\CadForncedor.mp4"));
                } catch (IOException ex) {
                    Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if (jcTutorial.getSelectedItem().toString() == "Funcionário") {
                try {
                    java.awt.Desktop.getDesktop().open(new File("src\\techpesc\\tutoriais\\CadFuncionario.mp4"));
                } catch (IOException ex) {
                    Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if (jcTutorial.getSelectedItem().toString() == "Lote") {
                try {
                    java.awt.Desktop.getDesktop().open(new File("src\\techpesc\\tutoriais\\CadLote.mp4"));
                } catch (IOException ex) {
                    Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            if (jcTutorial.getSelectedItem().toString() == "Tanque Rede") {
                try {
                    java.awt.Desktop.getDesktop().open(new File("src\\techpesc\\tutoriais\\CadTR.mp4"));
                } catch (IOException ex) {
                    Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            JOptionPane.showMessageDialog(rootPane, "Selecione qual tutorial deseja ver!!",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tutoriais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
